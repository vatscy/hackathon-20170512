  ...
  .done(function (result) {
    ...
    for (var i = 0, len = data.length; i < len; i++) {
      ...
      $list.append('<section class="list-rst js-bookmark js-done"><div class="list-rst__overview"><a href="/detail.html#'
        ...
        + toilet.name
        + '</h1><p class="list-rst__area-genre">新宿 / 洋式、ウォシュレット</p><div class="list-rst__rate"><p class="sptb-rating sptb-rating--lg sptb-rating--val35"><i class="sptb-rating__star"></i><b class="sptb-rating__val">'
